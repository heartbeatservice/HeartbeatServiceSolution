...
--GetProfessionalScheduleByProfessionalByDate @startDate='04/03/2014',@ProfessionalId=1
Declare @tblParams  table(id int identity(1,1),name varchar(50),paramName varchar(50))

SET @Sql='SELECT * FROM ProfessionalSchedule Where  startTime>'''+CONVERT(varchar,@StartDate,101) + ''' AND StartTime<'''+ CONVERT(varchar,@EndDate,101) +''''
